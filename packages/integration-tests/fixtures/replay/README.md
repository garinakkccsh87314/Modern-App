...
pnpm recording:export session-abc123-2024-01-15T10:30:00.000Z-x7k2m 2>&1 | \
...
```json
{
  ...
  "followUp": { /* follow-up message webhook */ }
}
```
...
```json
{
  ...
  "mention": { /* initial @mention in channel */ },
  "dmRequest": { /* user says "DM me" in thread */ },
  "dmMessage": { /* user's message in DM */ }
}
```

...
describe("fromReactElement", () => {
  // We need to test fromReactElement with mock React-like elements
  // since we can't import React in this test file

  it("throws error for HTML elements like div", async () => {
    const { fromReactElement } = await import("./cards");

    // Create a mock React element with a string type (HTML element)
    const divElement = {
  ...
  it("throws error for anchor elements", async () => {
    const { fromReactElement } = await import("./cards");
  ...
  it("throws error for span elements", async () => {
    const { fromReactElement } = await import("./cards");
  ...
  it("returns null for non-React elements", async () => {
    const { fromReactElement } = await import("./cards");
  ...
  it("returns card elements unchanged", async () => {
    const { fromReactElement, Card } = await import("./cards");

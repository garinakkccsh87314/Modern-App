---
title: Usage
description: Event handlers, threads, messages, and the core patterns of Chat SDK.
type: guide
prerequisites:
...
<Callout type="info">
Not all platforms support typing indicators. Teams and Google Chat do not have typing APIs. The call is a no-op on unsupported platforms.
</Callout>
...
// Async iterator over all messages (oldest first)
